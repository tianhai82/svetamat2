...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*checked*/ ctx[0]) return create_if_block_1;
    ...
    function create_fragment$4(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = !/*hideDetails*/ ctx[7] && create_if_block$1(ctx);
    ...
    function create_fragment$5(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = !/*hideDetails*/ ctx[6] && create_if_block$2(ctx);
  ...
  Demo Button
    ...
    class ButtonGuide extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$5, create_fragment$7, safe_not_equal, {}, [-1, -1]);
    	}
    }
    ...
    class Dialog extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$6, create_fragment$8, safe_not_equal, { visible: 0, permanent: 1 });
    	}
    }
  ...
  <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">permanent</div> 
    ...
    function create_if_block$5(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*visible*/ ctx[0] && create_if_block_1$1(ctx);
    ...
    class NavigationDrawer extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$8, create_fragment$a, safe_not_equal, { modal: 1, visible: 0, marginTop: 2 });
    	}
    }
  ...
  <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">date</div> 
    ...
    // (109:4) <Checkbox       bind:checked={checked2}       bind:indeterminate={indeterminate2}       color={color2}       disabled={disabled2}>
...
<Cascader
    ...
    function instance$s($$self, $$props, $$invalidate) {
    	...
    	let { textColor = "text-black" } = $$props;
    	let { trueColor = "bg-green-500" } = $$props;
    	let { falseColor = "bg-gray-100" } = $$props;
    	let { trueBgColor = "bg-green-300" } = $$props;
    ...
    /* src\widgets\RadioGroup.svelte generated by Svelte v3.31.0 */
    ...
    // (43:16) {#if isIdentical(item, value) }
    ...
    function create_each_block$2(ctx) {
    	...
    	let t2_value = (/*labelFieldName*/ ctx[8]
    	? /*item*/ ctx[16][/*labelFieldName*/ ctx[8]]
    	: /*item*/ ctx[16]) + "";
    	...
    	function change_handler() {
    		return /*change_handler*/ ctx[13](/*item*/ ctx[16]);
    	}

    	function input_handler() {
    		return /*input_handler*/ ctx[14](/*item*/ ctx[16]);
    	}

    	function select_block_type(ctx, dirty) {
    		if (show_if == null || dirty & /*items, value*/ 3) show_if = !!/*isIdentical*/ ctx[10](/*item*/ ctx[16], /*value*/ ctx[0]);
    	...
    	return {
    		c() {
    			...
    			attr(input, "name", "group");
    			input.disabled = /*disabled*/ ctx[2];
    			attr(span0, "class", span0_class_value = "" + (/*color*/ ctx[3] + " material-icons"));
    			attr(div, "class", "select-none rounded-full hover:bg-gray-300 w-8 h-8 flex items-center justify-center");
    			attr(span1, "class", /*labelColor*/ ctx[4]);
    			attr(label, "class", label_class_value = "" + (/*marginX*/ ctx[7] + " " + /*marginY*/ ctx[6] + " flex items-center"));
    			attr(label, "disabled", /*disabled*/ ctx[2]);
    			toggle_class(label, "cursor-not-allowed", /*disabled*/ ctx[2]);
    			toggle_class(label, "cursor-pointer", !/*disabled*/ ctx[2]);
    		},
    		m(target, anchor) {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty & /*color*/ 8 && span0_class_value !== (span0_class_value = "" + (/*color*/ ctx[3] + " material-icons"))) {
    				attr(span0, "class", span0_class_value);
    			}

    			if (dirty & /*labelFieldName, items*/ 258 && t2_value !== (t2_value = (/*labelFieldName*/ ctx[8]
    			? /*item*/ ctx[16][/*labelFieldName*/ ctx[8]]
    			: /*item*/ ctx[16]) + "")) set_data(t2, t2_value);

    			if (dirty & /*labelColor*/ 16) {
    				attr(span1, "class", /*labelColor*/ ctx[4]);
    			}

    			if (dirty & /*marginX, marginY*/ 192 && label_class_value !== (label_class_value = "" + (/*marginX*/ ctx[7] + " " + /*marginY*/ ctx[6] + " flex items-center"))) {
    			...
    			if (dirty & /*marginX, marginY, disabled*/ 196) {
    				toggle_class(label, "cursor-not-allowed", /*disabled*/ ctx[2]);
    			}
    ...
    function create_fragment$w(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", div_class_value = "flex" + (/*column*/ ctx[5] ? " flex-col" : ""));
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*marginX, marginY, disabled, labelColor, labelFieldName, items, color, isIdentical, value, handleChange*/ 2015) {
    			...
    			if (dirty & /*column*/ 32 && div_class_value !== (div_class_value = "flex" + (/*column*/ ctx[5] ? " flex-col" : ""))) {
    				attr(div, "class", div_class_value);
    			}
    		},
    		i: noop,
    ...
    function instance$u($$self, $$props, $$invalidate) {
    	...
    	let { value = "" } = $$props;
    	let { disabled = false } = $$props;
    	let { color = "text-gray-700" } = $$props;
    	let { labelColor = "text-gray-700" } = $$props;
    	let { row = true } = $$props;
    	let { column = false } = $$props;
    	let { marginY = "mb-1" } = $$props;
    	let { marginX = "mr-6" } = $$props;
    	let { labelFieldName = undefined } = $$props;
    	let { keywordFieldName = labelFieldName } = $$props;
    	...
    	const change_handler = item => handleChange(item);
    	const input_handler = item => handleChange(item);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("marginY" in $$props) $$invalidate(6, marginY = $$props.marginY);
    		if ("marginX" in $$props) $$invalidate(7, marginX = $$props.marginX);
    		if ("labelFieldName" in $$props) $$invalidate(8, labelFieldName = $$props.labelFieldName);
    		if ("keywordFieldName" in $$props) $$invalidate(12, keywordFieldName = $$props.keywordFieldName);
    	};
    ...
    /* src\components\RadioGroupGuide.svelte generated by Svelte v3.31.0 */
    ...
    function create_fragment$x(ctx) {
    	...
    	function checkbox0_checked_binding(value) {
    		/*checkbox0_checked_binding*/ ctx[12].call(null, value);
    	}
    	...
    	function radiogroup_value_binding(value) {
    		/*radiogroup_value_binding*/ ctx[13].call(null, value);
    	}
    	...
    	let radiogroup_props = {
    		...
    		labelFieldName: /*labelFieldName*/ ctx[4],
    		keywordFieldName: /*keywordFieldName*/ ctx[5],
    		row: /*row*/ ctx[6],
    		column: /*column*/ ctx[7],
    		marginY: /*marginY*/ ctx[9],
    		marginX: /*marginX*/ ctx[10]
    	};

    	if (/*value*/ ctx[0] !== void 0) {
    		radiogroup_props.value = /*value*/ ctx[0];
    	}

    	radiogroup = new RadioGroup({ props: radiogroup_props });
    	binding_callbacks.push(() => bind(radiogroup, "value", radiogroup_value_binding));

    	function checkbox1_checked_binding(value) {
    		/*checkbox1_checked_binding*/ ctx[14].call(null, value);
    	}

    	let checkbox1_props = { label: "disabled" };

    	if (/*disabled*/ ctx[1] !== void 0) {
    		checkbox1_props.checked = /*disabled*/ ctx[1];
    	}
    	...
    	function checkbox2_checked_binding(value) {
    		/*checkbox2_checked_binding*/ ctx[15].call(null, value);
    	}

    	let checkbox2_props = { label: "row" };

    	if (/*row*/ ctx[6] !== void 0) {
    		checkbox2_props.checked = /*row*/ ctx[6];
    	}
    	...
    	function checkbox3_checked_binding(value) {
    		/*checkbox3_checked_binding*/ ctx[16].call(null, value);
    	}

    	let checkbox3_props = { label: "column" };

    	if (/*column*/ ctx[7] !== void 0) {
    		checkbox3_props.checked = /*column*/ ctx[7];
    	}
    	...
    	function autocomplete0_value_binding(value) {
    		/*autocomplete0_value_binding*/ ctx[17].call(null, value);
    	}
    	...
    	if (/*labelFieldName*/ ctx[4] !== void 0) {
    		autocomplete0_props.value = /*labelFieldName*/ ctx[4];
    	}
    	...
    	function autocomplete1_value_binding(value) {
    		/*autocomplete1_value_binding*/ ctx[18].call(null, value);
    	}
    	...
    	if (/*keywordFieldName*/ ctx[5] !== void 0) {
    		autocomplete1_props.value = /*keywordFieldName*/ ctx[5];
    	}
    	...
    	if (/*color*/ ctx[2] !== void 0) {
    		input0_props.value = /*color*/ ctx[2];
    	}
    	...
    	if (/*labelColor*/ ctx[3] !== void 0) {
    		input1_props.value = /*labelColor*/ ctx[3];
    	}
    	...
    	input2 = new Input({
    			props: {
    				...
    				value: /*value*/ ctx[0][/*keywordFieldName*/ ctx[5]]
    			}
    		});
    	...
    	if (/*marginX*/ ctx[10] !== void 0) {
    		input3_props.value = /*marginX*/ ctx[10];
    	}
    	...
    	if (/*marginY*/ ctx[9] !== void 0) {
    		input4_props.value = /*marginY*/ ctx[9];
    	}
    	...
    	return {
    		c() {
    			h2 = element("h2");
    			h2.textContent = "Radio Group";
    			t1 = space();
    			div60 = element("div");

    			div60.innerHTML = `<h3 class="text-lg font-bold ml-3 mt-5 mb-3">Properties</h3> 
    <div class="table-row font-bold"><div class="table-cell py-3 px-3 border-b border-gray-400">Prop</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Description</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Type</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Default</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">items</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The list of items to choose from. Accepts an array of strings or objects.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">array</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">[]</div></div> 
    ...
    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">disabled</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Disables radio group.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">boolean</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">false</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">color</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The color of the radio buttons. Accepts valid Tailwindcss text color class</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">text-gray-700</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">labelColor</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The color of the label. Accepts valid Tailwindcss text color class</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">text-gray-700</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">row</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Displays radio buttons in row</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">boolean</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">true</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">column</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Displays radio buttons in column</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">boolean</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">true</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">marginX</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The horizontal margin between radio buttons</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">mr-6</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">true</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">marginY</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The vertical margin between radio buttons</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">mb-1</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">true</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">labelFieldName</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">When an array of objects is passed to &#39;items&#39;, this prop specifies the
            field to display.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">undefined</div></div> 

    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">keywordFieldName</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">When an array of objects is passed to &#39;items&#39;, this prop specifies the
            field to determine which item is selected.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">undefined</div></div>`;
...
<div class="my-2">
    <RadioGroup
        ...
        {marginX} />
    			...
    			attr(h2, "class", "text-xl ml-4 font-semibold my-6");
    			attr(div60, "class", "bg-gray-200 rounded my-4 px-4 table w-full");
    			attr(div61, "class", "text-lg font-bold");
    			attr(h31, "class", "mx-2 mb-2 flex justify-between");
    			attr(div62, "class", "my-2");
    			attr(div63, "class", "px-4");
    			attr(div64, "class", "px-4");
    			attr(div65, "class", "px-4");
    			attr(div66, "class", "w-full flex flex-row flex-wrap");
    			attr(div67, "class", "px-4 pb-2");
    			attr(div68, "class", "px-4 pb-2");
    			attr(div69, "class", "px-4 pb-2");
    			attr(div70, "class", "px-4 pb-2");
    			attr(div71, "class", "px-4 pb-2");
    			attr(div72, "class", "px-4 pb-2");
    			attr(div73, "class", "px-4 pb-2");
    			attr(div74, "class", "w-full flex flex-row flex-wrap");
    			attr(div75, "class", "border border-gray-500 rounded px-3 py-4 w-full");
    			attr(div76, "class", "bg-gray-200 rounded p-4 w-full");
    			attr(pre, "class", "my-2 bg-gray-200 rounded p-5 font-light text-sm");
    			toggle_class(pre, "hidden", !/*showCode*/ ctx[8]);
    		},
    		m(target, anchor) {
    			insert(target, h2, anchor);
    			...
    			append(div76, t102);
    			append(div76, div62);
    			mount_component(radiogroup, div62, null);
    			append(div76, t103);
    			append(div76, div75);
    			append(div75, div66);
    			append(div66, div63);
    			mount_component(checkbox1, div63, null);
    			append(div66, t104);
    			append(div66, div64);
    			mount_component(checkbox2, div64, null);
    			append(div66, t105);
    			append(div66, div65);
    			mount_component(checkbox3, div65, null);
    			append(div75, t106);
    			append(div75, div74);
    			append(div74, div67);
    			mount_component(autocomplete0, div67, null);
    			append(div74, t107);
    			append(div74, div68);
    			mount_component(autocomplete1, div68, null);
    			append(div74, t108);
    			append(div74, div69);
    			mount_component(input0, div69, null);
    			append(div74, t109);
    			append(div74, div70);
    			mount_component(input1, div70, null);
    			append(div74, t110);
    			append(div74, div71);
    			mount_component(input2, div71, null);
    			append(div74, t111);
    			append(div74, div72);
    			mount_component(input3, div72, null);
    			append(div74, t112);
    			append(div74, div73);
    			mount_component(input4, div73, null);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*color*/ 4) radiogroup_changes.color = /*color*/ ctx[2];
    			if (dirty & /*labelColor*/ 8) radiogroup_changes.labelColor = /*labelColor*/ ctx[3];
    			if (dirty & /*disabled*/ 2) radiogroup_changes.disabled = /*disabled*/ ctx[1];
    			if (dirty & /*labelFieldName*/ 16) radiogroup_changes.labelFieldName = /*labelFieldName*/ ctx[4];
    			if (dirty & /*keywordFieldName*/ 32) radiogroup_changes.keywordFieldName = /*keywordFieldName*/ ctx[5];
    			if (dirty & /*row*/ 64) radiogroup_changes.row = /*row*/ ctx[6];
    			if (dirty & /*column*/ 128) radiogroup_changes.column = /*column*/ ctx[7];
    			if (dirty & /*marginY*/ 512) radiogroup_changes.marginY = /*marginY*/ ctx[9];
    			if (dirty & /*marginX*/ 1024) radiogroup_changes.marginX = /*marginX*/ ctx[10];

    			if (!updating_value && dirty & /*value*/ 1) {
    				updating_value = true;
    				radiogroup_changes.value = /*value*/ ctx[0];
    				add_flush_callback(() => updating_value = false);
    			}
    			...
    			if (!updating_checked_1 && dirty & /*disabled*/ 2) {
    				updating_checked_1 = true;
    				checkbox1_changes.checked = /*disabled*/ ctx[1];
    				add_flush_callback(() => updating_checked_1 = false);
    			}
    			...
    			if (!updating_checked_2 && dirty & /*row*/ 64) {
    				updating_checked_2 = true;
    				checkbox2_changes.checked = /*row*/ ctx[6];
    				add_flush_callback(() => updating_checked_2 = false);
    			}
    			...
    			if (!updating_checked_3 && dirty & /*column*/ 128) {
    				updating_checked_3 = true;
    				checkbox3_changes.checked = /*column*/ ctx[7];
    				add_flush_callback(() => updating_checked_3 = false);
    			}
    			...
    			if (!updating_value_1 && dirty & /*labelFieldName*/ 16) {
    				updating_value_1 = true;
    				autocomplete0_changes.value = /*labelFieldName*/ ctx[4];
    				add_flush_callback(() => updating_value_1 = false);
    			}
    			...
    			if (!updating_value_2 && dirty & /*keywordFieldName*/ 32) {
    				updating_value_2 = true;
    				autocomplete1_changes.value = /*keywordFieldName*/ ctx[5];
    				add_flush_callback(() => updating_value_2 = false);
    			}
    			...
    			if (!updating_value_3 && dirty & /*color*/ 4) {
    				updating_value_3 = true;
    				input0_changes.value = /*color*/ ctx[2];
    				add_flush_callback(() => updating_value_3 = false);
    			}
    			...
    			if (!updating_value_4 && dirty & /*labelColor*/ 8) {
    				updating_value_4 = true;
    				input1_changes.value = /*labelColor*/ ctx[3];
    				add_flush_callback(() => updating_value_4 = false);
    			}

    			input1.$set(input1_changes);
    			const input2_changes = {};
    			if (dirty & /*value, keywordFieldName*/ 33) input2_changes.value = /*value*/ ctx[0][/*keywordFieldName*/ ctx[5]];
    			input2.$set(input2_changes);
    			const input3_changes = {};

    			if (!updating_value_5 && dirty & /*marginX*/ 1024) {
    				updating_value_5 = true;
    				input3_changes.value = /*marginX*/ ctx[10];
    				add_flush_callback(() => updating_value_5 = false);
    			}
    			...
    			if (!updating_value_6 && dirty & /*marginY*/ 512) {
    				updating_value_6 = true;
    				input4_changes.value = /*marginY*/ ctx[9];
    				add_flush_callback(() => updating_value_6 = false);
    			}
    ...
    function instance$v($$self, $$props, $$invalidate) {
    	...
    	function radiogroup_value_binding(value$1) {
    		value = value$1;
    		$$invalidate(0, value);
    	}
    	...
    	function autocomplete0_value_binding(value) {
    		labelFieldName = value;
    		$$invalidate(4, labelFieldName);
    	}

    	function autocomplete1_value_binding(value) {
    		keywordFieldName = value;
    		$$invalidate(5, keywordFieldName);
    	}
    	...
    	function input1_value_binding(value) {
    		labelColor = value;
    		$$invalidate(3, labelColor);
    	}

    	function input3_value_binding(value) {
    		marginX = value;
    		$$invalidate(10, marginX);
    	}

    	function input4_value_binding(value) {
    		marginY = value;
    		$$invalidate(9, marginY);
    	}
    ...
    class RadioGroupGuide extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    /* src\widgets\Radio.svelte generated by Svelte v3.31.0 */
    ...
    function create_fragment$y(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(input, "class", "hidden");
    			attr(input, "type", "radio");
    			attr(input, "name", /*group*/ ctx[2]);
    			input.disabled = /*disabled*/ ctx[5];
    			input.value = /*value*/ ctx[1];
    			attr(span, "class", "material-icons");
    			attr(div, "class", "select-none rounded-full hover:bg-gray-300 w-8 h-8 flex items-center justify-center");
    			attr(label_1, "class", label_1_class_value = "" + (/*color*/ ctx[4] + " flex items-center"));
    			attr(label_1, "disabled", /*disabled*/ ctx[5]);
    			toggle_class(label_1, "cursor-not-allowed", /*disabled*/ ctx[5]);
    			toggle_class(label_1, "cursor-pointer", !/*disabled*/ ctx[5]);
    		},
    		m(target, anchor) {
    			insert(target, label_1, anchor);
    			append(label_1, input);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*color*/ 16 && label_1_class_value !== (label_1_class_value = "" + (/*color*/ ctx[4] + " flex items-center"))) {
    				attr(label_1, "class", label_1_class_value);
    			}
    ...
    /* src\components\RadioGuide.svelte generated by Svelte v3.31.0 */
    ...
    function create_default_slot$d(ctx) {
    	...
    	return {
    		c() {
    			...
    			t1 = space();
    			span = element("span");
    			span.textContent = "Radio button with slot";
    			attr(i, "class", "material-icons text-blue-700");
    			attr(span, "class", "text-orange-500");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$z(ctx) {
    	...
    	function radio0_value_binding(value) {
    		/*radio0_value_binding*/ ctx[11].call(null, value);
    	}
    	...
    	if (/*value2*/ ctx[4] !== void 0) {
    		radio1_props.value = /*value2*/ ctx[4];
    	}

    	radio1 = new Radio({ props: radio1_props });
    	binding_callbacks.push(() => bind(radio1, "value", radio1_value_binding));
    	radio1.$on("change", /*radioChanged*/ ctx[9]);

    	function checkbox1_checked_binding(value) {
    		/*checkbox1_checked_binding*/ ctx[13].call(null, value);
    	}

    	let checkbox1_props = { label: "disabled1" };

    	if (/*disabled1*/ ctx[3] !== void 0) {
    		checkbox1_props.checked = /*disabled1*/ ctx[3];
    	}
    	...
    	if (/*label1*/ ctx[0] !== void 0) {
    		input1_props.value = /*label1*/ ctx[0];
    	}
    	...
    	if (/*color1*/ ctx[2] !== void 0) {
    		input2_props.value = /*color1*/ ctx[2];
    	}
    	...
    	function checkbox2_checked_binding(value) {
    		/*checkbox2_checked_binding*/ ctx[16].call(null, value);
    	}

    	let checkbox2_props = { label: "disabled2" };

    	if (/*disabled2*/ ctx[6] !== void 0) {
    		checkbox2_props.checked = /*disabled2*/ ctx[6];
    	}
    ...
    <div class="table-row font-bold"><div class="table-cell py-3 px-3 border-b border-gray-400">Prop</div> 
        ...
        <div class="table-cell py-3 px-3 border-b border-gray-400">Default</div></div> 
    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">label</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The label text of the radio button.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">&#39;&#39;</div></div> 
    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">value</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The value of the radio button.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">&#39;&#39;</div></div> 
    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">checked</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Whether the radio button is selected.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">boolean</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">false</div></div> 
    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">group</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The group this radio button belongs to.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">&#39;&#39;</div></div> 
    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">color</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">The color of the radio button and the label. Accepts Tailwindcss text color</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">string</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">text-black</div></div> 
    <div class="table-row"><div class="table-cell py-3 px-3 border-b border-gray-400">disabled</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">Whether the radio button is disabled.</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">boolean</div> 
        <div class="table-cell py-3 px-3 border-b border-gray-400">false</div></div>`;
...
<div class="mt-2 mb-1 flex justify-evenly">
    ...
    <Radio
        ...
        <span class="text-orange-500">Radio button with slot</span>
    			...
    			attr(h31, "class", "mx-2 mb-2 flex justify-between");
    			attr(div37, "class", "mt-2 mb-1 flex justify-evenly");
    			attr(div38, "class", "px-4");
    			attr(div39, "class", "w-full flex flex-row flex-wrap");
    			attr(div40, "class", "px-4 pb-2");
    			attr(div41, "class", "px-4 pb-2");
    			attr(div42, "class", "px-4 pb-2");
    			attr(div43, "class", "w-full flex flex-row flex-wrap");
    			attr(div44, "class", "px-4");
    			attr(div45, "class", "w-full flex flex-row flex-wrap");
    			attr(div46, "class", "px-4 pb-2");
    			attr(div47, "class", "px-4 pb-2");
    		...
    		m(target, anchor) {
    			...
    			append(div43, t66);
    			append(div43, div41);
    			mount_component(input1, div41, null);
    			append(div43, t67);
    			append(div43, div42);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (!updating_value && dirty & /*value1*/ 2) {
    				updating_value = true;
    				radio0_changes.value = /*value1*/ ctx[1];
    				add_flush_callback(() => updating_value = false);
    			}
    			...
    			if (!updating_value_1 && dirty & /*value2*/ 16) {
    				updating_value_1 = true;
    				radio1_changes.value = /*value2*/ ctx[4];
    				add_flush_callback(() => updating_value_1 = false);
    			}
    			...
    			if (!updating_checked_1 && dirty & /*disabled1*/ 8) {
    				updating_checked_1 = true;
    				checkbox1_changes.checked = /*disabled1*/ ctx[3];
    				add_flush_callback(() => updating_checked_1 = false);
    			}
    			...
    			if (!updating_value_2 && dirty & /*label1*/ 1) {
    				updating_value_2 = true;
    				input1_changes.value = /*label1*/ ctx[0];
    				add_flush_callback(() => updating_value_2 = false);
    			}
    			...
    			if (!updating_value_3 && dirty & /*color1*/ 4) {
    				updating_value_3 = true;
    				input2_changes.value = /*color1*/ ctx[2];
    				add_flush_callback(() => updating_value_3 = false);
    			}
    			...
    			if (!updating_checked_2 && dirty & /*disabled2*/ 64) {
    				updating_checked_2 = true;
    				checkbox2_changes.checked = /*disabled2*/ ctx[6];
    				add_flush_callback(() => updating_checked_2 = false);
    			}
    ...
    function instance$x($$self, $$props, $$invalidate) {
    	...
    	function radioChanged({ detail }) {
    		$$invalidate(7, selectedValue = detail);
    	}
    ...
    class RadioGuide extends SvelteComponent {
    	constructor(options) {
    		super();
